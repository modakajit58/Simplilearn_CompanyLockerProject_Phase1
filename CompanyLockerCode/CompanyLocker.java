...
public class CompanyLocker {	
	...
	private static final String MAIN_MENU_OPTIONS =
	 ...
	 private static final String SECONDARY_MENU_OPTIONS =
	            "   \nSelect any of the following: \n"+
	                    "\t\t   a -> Add a desire file\n"+
	                    "\t\t   b -> Delete a desire file\n"+
	                    "\t\t   c -> Search a desire file \n"+
		...
		System.out.println(MAIN_MENU_OPTIONS);
		  try{
	            ...
	            switch (option){
	                ...
	                case 3 : {
	                    System.out.println("Thank for choosing LockedMe.com");
	                    System.exit(0);
	                }
	                default: 
	...
	public static void main(String[] args) {
		...
		CompanyLocker menu = new CompanyLocker();
